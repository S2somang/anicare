...
/**
 * Servlet implementation class InsertEducationMaterialsAdminServlet
 */
@WebServlet("/insertMaterialsAdmin.ed")
public class InsertEducationMaterialsAdminServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public InsertEducationMaterialsAdminServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		if(ServletFileUpload.isMultipartContent(request)) {
			...
			String filePath = root + "resources/uploadFiles/education/";
			...
			int result = new MaterialsService().insertMaterials(requestData);
