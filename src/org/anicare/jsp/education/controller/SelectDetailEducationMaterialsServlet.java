...
/**
 * Servlet implementation class SelectDetailEducationMaterialsServlet
 */
@WebServlet("/selectDetailMaterials.ed")
public class SelectDetailEducationMaterialsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelectDetailEducationMaterialsServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(hmap != null) {
			...
			path = "views/education/materialsDetail.jsp";
		} else {
			request.setAttribute("message", "자료게시판 상세보기 실패");
