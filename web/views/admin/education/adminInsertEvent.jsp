...
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/resources/css/admin/education/adminInsertEvent.css">
					...
					<form id="writeForm" method="post" encType="multipart/form-data">
						...
						<ul class="top">
							...
							<li >
								<div class="thumbnail-area">
									<label> 미리보기</label>
									<img id="thumbnail" width="145" height="100">
								</div>
								<div class="file-area">
						...
						<ul class="contArea bottom">
							<li><label>내용</label> 
								...
								<div contentEditable="true" id="inputContent" style="resize: none;"></div>
